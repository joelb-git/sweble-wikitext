...
public class EntityReferences
{
	...
	static
	{
        ...
        // 2016/08/03 joelb: Basis Technology - fixing bug in old 1.1.1 code
        // since we're not ready to move to sweble 2.x yet.  Took correct
        // hex codes from here:
        // https://github.com/sweble/sweble-wikitext/blob/2a3d271dcdf2fa661efe8aca04202107d7547a01/swc-engine/src/main/java/org/sweble/wikitext/engine/utils/DefaultConfig.java#L133
		add("nbsp", "\u00a0");
		add("iexcl", "\u00a1");
		add("cent", "\u00a2");
		add("pound", "\u00a3");
